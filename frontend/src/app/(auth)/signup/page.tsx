        ...
        <div className="min-h-screen flex items-center justify-center bg-background px-4">
            <div className="max-w-sm w-full p-6 rounded-2xl bg-card border border-white/10 shadow-2xl">
                ...
                <p className="mt-6 text-center text-gray-400 text-sm">
                    ...
                    <Link href="/login" className="font-bold bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500 hover:opacity-80 transition-opacity ml-1">
                        Login
                    </Link>
                </p>
            </div>
